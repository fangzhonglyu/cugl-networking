...
#pragma mark Virtual Methods
    ...
    /**
     * This method is called for necessary updates before the physical simulation step. 
     * Example Tasks to perform in this step:
     * - Updating the input controller
     * - Checking for loading screen
     */

    virtual void preUpdate(float timestep) { }

    /**
     * This method is called after the physical simulation step.
     */
    virtual void postUpdate(float timestep) { }

    /**
     * The method called to update the application data by a fixed amount defined by FIXED_TIMESTEP.
     *
