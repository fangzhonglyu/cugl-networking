...
OSSL_PATH := $(LOCAL_PATH)/../openssl
include $(CLEAR_VARS)

LOCAL_MODULE := srtp2
LOCAL_C_INCLUDES := $(PROJ_PATH)/android/$(TARGET_ARCH_ABI)
LOCAL_C_INCLUDES += $(PROJ_PATH)/include
LOCAL_C_INCLUDES += $(PROJ_PATH)/crypto/include
LOCAL_C_INCLUDES += $(OSSL_PATH)
LOCAL_C_INCLUDES += $(OSSL_PATH)/include
LOCAL_C_INCLUDES += $(OSSL_PATH)/android/$(TARGET_ARCH_ABI)/crypto
